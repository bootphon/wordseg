...
namespace sampler
{
    ...
    {
    public:
        unigram(const data::data& constants);
        virtual ~unigram();
        virtual bool sanity_check() const;
        virtual double log_posterior() const;
        virtual std::vector<double> predict_pairs(const TestPairs& test_pairs) const;
    ...
    {
    public:
        batch_unigram(const data::data& constants);
    ...
    {
    public:
        online_unigram(const data::data& constants, double forget_rate = 0);
